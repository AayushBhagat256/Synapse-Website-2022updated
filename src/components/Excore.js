...
function Excore() {
  ...
  return (
    <div className='excore'>
      <h1 className='headingexcore'>This is Ex-Core </h1>


<div className="container">
    <h1 className='hello1excore'>hello Ex-Core</h1>
    <div className="row">
